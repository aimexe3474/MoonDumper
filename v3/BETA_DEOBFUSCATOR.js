...
var input = fs.readFileSync('C:/Users/ASUS/Desktop/v3/input.lua', 'utf8');
var x = fs.writeFileSync('C:/Users/ASUS/Desktop/v3/deobfuscated.lua', '-- [BYFRON] : Byfron Moonsec V3 Deobfuscator @ https://discord.gg/SXQvSGme7F\nthingbytecode="";\n' + input);
var newinput = fs.readFileSync('C:/Users/ASUS/Desktop/v3/deobfuscated.lua', 'utf8');
...
if (matches) {
    try {
        ...
        fs.writeFileSync('C:/Users/ASUS/Desktop/v3/deobfuscated.lua', newinput);
